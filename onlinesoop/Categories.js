      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16, backgroundColor: '#FFFFFF' }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
          ...
          <TouchableOpacity onPress={() => navigation.goBack()} style={{ paddingRight: 8 }}>
            <Image source={require('./assets/gr.png')} style={{ width: 20, height: 20, tintColor: '#333333' }} />
          </TouchableOpacity>
          <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#333333', flex: 1, textAlign: 'center' }}>
            Categories
          </Text>
          <TouchableOpacity style={{ paddingLeft: 8 }}>
            <Image source={require('./assets/lk.png')} style={{ width: 20, height: 20, tintColor: '#333333' }} />
          </TouchableOpacity>
        </View>
      ...
      <ScrollView>
        ...
        <View style={{ paddingHorizontal: 16, marginTop: 16 }}>
          <TouchableOpacity style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F9F9', padding: 10, borderRadius: 8 }}>
            ...
            <Image source={require('./assets/lurus.jpeg')} style={{ width: 80, height: 80, borderRadius: 8 }} />
          </TouchableOpacity>
          <TouchableOpacity style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F9F9', padding: 10, borderRadius: 8 }}>
            <Text style={{ fontSize: 18, fontWeight: '600', color: '#333333', flex: 1 }}>Clothes</Text>
            <Image source={require('./assets/pink.jpeg')} style={{ width: 80, height: 80, borderRadius: 8 }} />
          </TouchableOpacity>
          <TouchableOpacity style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F9F9', padding: 10, borderRadius: 8 }}>
            <Text style={{ fontSize: 18, fontWeight: '600', color: '#333333', flex: 1 }}>Shoes</Text>
            <Image source={require('./assets/mr.jpeg')} style={{ width: 80, height: 80, borderRadius: 8 }} />
          </TouchableOpacity>
          <TouchableOpacity style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F9F9', padding: 10, borderRadius: 8 }}>
            <Text style={{ fontSize: 18, fontWeight: '600', color: '#333333', flex: 1 }}>Accessories</Text>
            <Image source={require('./assets/lk.png')} style={{ width: 80, height: 80, borderRadius: 8 }} />
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
